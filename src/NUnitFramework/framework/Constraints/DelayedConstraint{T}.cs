...
namespace NUnit.Framework.Constraints
{
    ...
    ///</summary>
    public class DelayedConstraint<T> : PrefixConstraint<T>
    {
        /// <summary>
        /// Allows only changing the time dimension of delay interval and setting a polling interval of a DelayedConstraint
        /// </summary>
        public class WithRawDelayInterval : DelayedConstraint<T>
        {
            private readonly DelayedConstraint<T> _parent;
            ...
            public WithRawDelayInterval(DelayedConstraint<T> parent)
        ...
        /// </summary>
        public class WithDimensionedDelayInterval : DelayedConstraint<T>
        {
            private readonly DelayedConstraint<T> _parent;
            ...
            public WithDimensionedDelayInterval(DelayedConstraint<T> parent)
                : base(parent.BaseConstraint, parent.DelayInterval, parent.PollingInterval)
            {
                DelayInterval = parent.DelayInterval;
                _parent = parent;
        ...
        /// </summary>
        public class WithRawPollingInterval : DelayedConstraint<T>
        {
            private readonly DelayedConstraint<T> _parent;
            ...
            public WithRawPollingInterval(DelayedConstraint<T> parent)
                : base(parent.BaseConstraint, parent.DelayInterval, parent.PollingInterval)
            {
                _parent = parent;
            }
            ...
            /// </summary>
            public DelayedConstraint<T> Minutes
            {
                get
                {
            ...
            /// </summary>
            public DelayedConstraint<T> Seconds
            {
                get
                {
            ...
            /// </summary>
            public DelayedConstraint<T> MilliSeconds
            {
                get
                {
        ...
        public DelayedConstraint(IConstraint<T> baseConstraint, int delayInMilliseconds)
        ...
        ///<exception cref="InvalidOperationException">If the value of <paramref name="delayInMilliseconds"/> is less than 0</exception>
        public DelayedConstraint(IConstraint<T> baseConstraint, int delayInMilliseconds, int pollingIntervalInMilliseconds)
        ...
        private DelayedConstraint(IConstraint<T> baseConstraint, Interval delayInterval, Interval pollingInterval)
            : base(baseConstraint, string.Empty)
        {
        ...
        public override ConstraintResult ApplyTo(T actual)
        {
        ...
        public override ConstraintResult ApplyTo(Func<T> del)
        {
            return PollLoop(() => BaseConstraint.ApplyTo(del));
        }

        /// <inheritdoc/>
        public override async Task<ConstraintResult> ApplyToAsync(Func<Task<T>> taskDel)
        {
        ...
        private class DelegatingConstraintResult : ConstraintResult
        {
            ...
            public DelegatingConstraintResult(IConstraint<T> constraint, ConstraintResult innerResult)
