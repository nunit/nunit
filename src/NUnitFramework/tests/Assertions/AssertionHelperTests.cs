...
namespace NUnit.Framework.Syntax
{
    class AssertionHelperTests : AssertionHelper
    {
        ...
        public void After()
        {
            ...
            Expect(constraint.ToString(), EqualTo("<after 1000 millisecond <equal 10>>"));
        }
        ...
        public void After_Property()
        {
            ...
            Expect(constraint, TypeOf<DelayedConstraint>());
            Expect(constraint.ToString(), EqualTo("<after 1000 millisecond <property X <equal 10>>>"));
        }
        ...
        public void After_And()
        {
            ...
            Expect(constraint, TypeOf<DelayedConstraint>());
            Expect(constraint.ToString(), EqualTo("<after 1000 millisecond <and <greaterthan 0> <lessthan 10>>>"));
        }
#endif
