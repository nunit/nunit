...
namespace NUnit.Framework.Tests.Internal.Filters
{
    ...
    public abstract class TestFilterTests
    {
        ...
        protected readonly TestSuite FixtureWithLongTestCaseNameSuite = TestBuilder.MakeFixture(typeof(FixtureWithLongTestCaseName));
        ...
        private class FixtureWithLongTestCaseName
        {
