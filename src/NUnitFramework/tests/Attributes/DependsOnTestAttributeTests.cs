...
namespace NUnit.Framework.Tests.Attributes
{
    [TestFixture]
    [NonParallelizable]
    public class DependsOnTestAttributeTests
    {
        [SetUp]
        public void SetUp()
        {
        ...
        [Test]
        public void AttributeUsageIsMethodLevelSingleUse()
        {
            var usage = (AttributeUsageAttribute?)Attribute.GetCustomAttribute(typeof(DependsOnTestAttribute), typeof(AttributeUsageAttribute));

            Assert.That(usage, Is.Not.Null, $"{nameof(DependsOnTestAttribute)} should have an AttributeUsage attribute.");
        ...
        public void AppliesPropertiesForMethodDependencies()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                Assert.That(test.Properties.Get(PropertyNames.DependsOnTest), Is.EqualTo(nameof(MethodDependencyOrdered.Before)));
