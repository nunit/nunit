...
namespace NUnit.Framework.Classic
{
    ...
    public static class DirectoryAssert
    {
        ...
        {
            Framework.Assert.That(actual, new FileOrDirectoryExistsConstraint().IgnoreFiles, message, args);
        }
        ...
        {
            Framework.Assert.That(actual, new NotConstraint(new FileOrDirectoryExistsConstraint().IgnoreFiles), message, args);
        }
