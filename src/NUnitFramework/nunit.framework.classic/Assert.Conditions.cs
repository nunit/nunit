...
namespace NUnit.Framework.Classic
{
    public abstract partial class Assert
    {
        ...
        {
            Framework.Assert.That(condition, Is.True, message, args);
        }
        ...
        {
            Framework.Assert.That(condition, Is.True, null, null);
        }
        ...
        {
            Framework.Assert.That(condition, Is.False, null, null);
        }
        ...
        {
            Framework.Assert.That(anObject, Is.Not.Null, message, args);
        }
        ...
        {
            Framework.Assert.That(anObject, Is.Not.Null, null, null);
        }
        ...
        {
            Framework.Assert.That(anObject, Is.Null, message, args);
        }
        ...
        {
            Framework.Assert.That(anObject, Is.Null, null, null);
        }
        ...
        {
            Framework.Assert.That(aDouble, Is.NaN, message, args);
        }
        ...
        {
            Framework.Assert.That(aDouble, Is.NaN, null, null);
        }
        ...
        {
            Framework.Assert.That(aString, new EmptyStringConstraint(), message, args);
        }
        ...
        {
            Framework.Assert.That(aString, new EmptyStringConstraint(), null, null);
        }
        ...
        {
            Framework.Assert.That(collection, new EmptyCollectionConstraint(), null, null);
        }
        ...
        {
            Framework.Assert.That(aString, Is.Not.Empty, message, args);
        }
        ...
        {
            Framework.Assert.That(aString, Is.Not.Empty, null, null);
        }
        ...
        {
            Framework.Assert.That(collection, Is.Not.Empty, message, args);
        }
        ...
        {
            Framework.Assert.That(collection, Is.Not.Empty, null, null);
        }
        ...
        {
            Framework.Assert.That(actual, Is.Zero, message, args);
        }
        ...
        {
            Framework.Assert.That(actual, Is.Not.Zero, message, args);
        }
        ...
        {
            Framework.Assert.That(actual, Is.Positive, message, args);
        }
        ...
        {
            Framework.Assert.That(actual, Is.Negative, message, args);
        }
