...
namespace NUnit.Framework.Classic
{
    public partial class Assert
    {
        ...
        {
            That(actual, Is.AssignableFrom(expected));
        }
        ...
        {
            That(actual, Is.AssignableFrom(typeof(TExpected)));
        }
        ...
        {
            That(actual, Is.Not.AssignableFrom(expected));
        }
        ...
        {
            That(actual, Is.Not.AssignableFrom(typeof(TExpected)));
        }
        ...
        {
            That(actual, Is.InstanceOf(expected));
        }
        ...
        {
            That(actual, Is.InstanceOf(typeof(TExpected)));
        }
        ...
        {
            That(actual, Is.Not.InstanceOf(expected));
        }
        ...
        {
            That(actual, Is.Not.InstanceOf(typeof(TExpected)));
        }
